...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        self.r_o = None  # RX positions now come per-sample from rx_pos.csv
        ...
        self.train_set = dataset(self.datadir, train_index, n_rx=50)
        self.test_set = dataset(self.datadir, test_index, n_rx=50)

        self.has_rx_pos = self.train_set.has_rx_pos
